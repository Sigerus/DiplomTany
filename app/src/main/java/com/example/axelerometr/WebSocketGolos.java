...
public class WebSocketGolos extends WebSocketListener {
    ...
    public void onMessage(WebSocket webSocket, String text)
    {
        ...
        Log.d(TAG, text);
       // Log.d(TAG, Message[10]);
       /* Log.d(TAG, Message[105]);
        Log.d(TAG, Message[150]);
        Log.d(TAG, Message[200]);
        Log.e(TAG2, String.valueOf(Message));
        Log.i(TAG, String.valueOf(Message));
        Log.v(TAG, String.valueOf(Message));
        Log.w(TAG, String.valueOf(Mass));*/
       // String Guid;
       // Color color;
       /* switch (Code){
            case "id":
